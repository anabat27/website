import{d as _,a3 as u,z as h,f as n,g as t,t as s,C as r,F as f,ai as g,o as l,i as v,e as x,ac as b}from"../modules/vue-D_w8vJnA.js";import{a as y,u as N,x as m}from"../index-PbkqFcf0.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-DfTHt9zh.js";import"../modules/shiki-Djc3AMye.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(D){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
